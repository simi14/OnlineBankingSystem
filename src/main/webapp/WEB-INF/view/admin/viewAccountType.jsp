...
<title>Admin | A/C Type Details</title>
<!-- plugins:css -->
<link rel="stylesheet"
									...
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<c:forEach items="${searchList}" var="p">
												<tr>
													<td>${p.accounttype_name }</td>
													<td>${p.accounttype_description }</td>
													<td><a href="editAccountType?id=${p.accounttype_id}"><i class="mdi mdi-pencil-box"
															style="font-size: 20px; margin-left: 15px;"></i></a> <a
														href="deleteAccountType?id=${p.accounttype_id}"><i class="mdi mdi-delete"
