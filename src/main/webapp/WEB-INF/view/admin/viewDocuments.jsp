...
<title>Admin | Documents Details</title>
<!-- plugins:css -->
<link rel="stylesheet"
											...
											<tbody>
												<c:forEach items="${searchList}" var="p" varStatus="j">
													<tr>
														...
														<td>${p.document_description}</td>
														<td><img src="<%=request.getContextPath()%>/documents/demoDocuments/${p.documentFileName}"></td>
														<td><a href="editDocuments?id=${p.document_id}"><i
																class="mdi mdi-pencil-box"
																style="font-size: 20px; margin-left: 15px;"></i></a> <a
															href="deleteDocuments?id=${p.document_id}"><i
