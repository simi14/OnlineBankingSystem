...
<title>Admin | Account Required Docs</title>
<!-- plugins:css -->
<link rel="stylesheet"
				...
				<div class="content-wrapper">
					<div class="row">
						<div class="col-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Add Account Required Documents</h4>
									<form class="forms-sample" action="insertAccountDocuments">

										<div class="form-group">
											<label>Account</label> 
											 <select
												class="js-example-basic-multiple w-100" name="aid" >
												<c:forEach items="${sessionScope.account_list}" var="i">
