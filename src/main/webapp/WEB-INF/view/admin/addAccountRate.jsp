...
<title>Admin | Add A/C Rate</title>
<!-- plugins:css -->
<link rel="stylesheet"
				...
				<div class="content-wrapper">
					<div class="row">
						<div class="col-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Add Account Rate</h4>
									<form class="forms-sample">
										...
										<div class="form-group">
											<label>Account Type</label> <select
												...
												<!-- multiple="multiple" -->
												<option value="AL">Savings</option>
												<option value="WY">Current</option>
										...
										<div class="form-group">
											<label for="exampleAccountrate1">Account Rate</label> <input
												type="text" class="form-control" id="exampleAccountrate1"
												placeholder="Account Type">
										</div>

										<div class="form-group">
											<label for="exampleAccountdescription1">Description</label>
											<textarea class="form-control" id="exampleAccountdescription1"
												rows="4"></textarea>
										</div>
