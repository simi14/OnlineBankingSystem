...
<body>
	<f:form action="insertServices" post="Post" modelAttribute="servicesVO" onsubmit="return addServices()">
								...
								<div class="card-body">
									...
									<form class="forms-sample">
										<div class="form-group">
											<label for="exampleServices">Name</label> 
											<!-- <input type="text" class="form-control" id="exampleServices"
												placeholder="Service"> -->
											<f:input path="service_name" id="service_name" placeholder="Service" class="form-control" />
										</div>
										<div class="form-group">
											<label for="exampleServicedescription1">Description</label>
											<f:textarea path="service_description" id="service_description" class="form-control" rows="4"/>
										<!-- 	<textarea class="form-control" id="exampleServicedescription1" rows="4"></textarea>
										 --></div>
										 <f:hidden path="service_id" />
