...
<title>Admin | Required Doc Details</title>
<!-- plugins:css -->
<link rel="stylesheet"
									...
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<c:forEach items="${searchList}" var="p" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${p.servicesVO.service_name }</td>
													<td>${p.documentsVO.document_name}</td>
													<td><a href="editRequiredDocuments?id=${p.requiredDocument_id}"><i class="mdi mdi-pencil-box"
															style="font-size: 20px; margin-left: 15px;"></i></a> <a
														href="deleteRequiredDocuments?id=${p.requiredDocument_id}"><i class="mdi mdi-delete"
