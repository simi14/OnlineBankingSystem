...
<title>Admin | Branch Details</title>
<!-- plugins:css -->
<link rel="stylesheet"
										...
										<table id="order-listing" class="table">
											...
											<c:forEach items="${searchList}" var="p" varStatus="j">
												<tr>
													...
													<td>${p.ifscCode}</td>
													<td>${p.branchName}</td>
													<td>${p.branchAddress}</td>
													<td>${p.stateVO.state_name}</td>
													<td>${p.cityVO.city_name}</td>
													<td><a href="editBranch?id=${p.branchId}"><i class="mdi mdi-pencil-box"
															style="font-size: 20px; margin-left: 15px;"></i></a> <a
														href="deleteBranch?id=${p.branchId}"><i class="mdi mdi-delete"
